    ...
    if (mysqli_num_rows($cek_user) > 0) {
        ...
        if ($update) {
            ...
            try {
                ...
                $mail->setFrom('pthtmi123@gmail.com', 'UJIAN ONLINE SYSTEM');
                $mail->addAddress($email);
                $mail->isHTML(true);
                $mail->Subject = 'Kode OTP Verifikasi - UJIAN ONLINE';
                $mail->Body = "
<!DOCTYPE html>
<html>
<head>
                    ...
                    <tr>
                        <td style='padding: 40px;'>
                            ...
                            <p style='margin: 0 0 20px 0; font-size: 14px; color: #4a5568; line-height: 1.6;'>
                                Berikut adalah kode OTP Anda untuk melanjutkan proses perubahan password di sistem <strong>UJIAN ONLINE</strong>:
                            </p>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' style='border-top: 1px solid #edf2f7; padding-top: 20px;'>
                                <tr>
                                    <td style='font-size: 11px; color: #a0aec0; text-align: center; line-height: 1.6;'>
                                        IT Department - PT. UJIAN ONLINE.<br>
